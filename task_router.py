...
@router.post("/tasks", response_model=Todo, status_code = 201 )
...
@router.get("/tasks/{task_id}", response_model=Todo)
...
@router.put("/tasks/{task_id}", response_model=Todo)
...
@router.patch("/tasks/{task_id}/complete", response_model=Todo)
...
@router.patch("/tasks/{task_id}/undo", response_model=Todo)
